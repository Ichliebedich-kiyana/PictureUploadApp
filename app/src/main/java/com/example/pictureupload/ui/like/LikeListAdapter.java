...
public class LikeListAdapter extends RecyclerView.Adapter<LikeListAdapter.ViewHolder> {
    ...
    private List<LikeBean.DataBean.RecordsBean> lists;
    ...
    public LikeListAdapter(List<LikeBean.DataBean.RecordsBean> lists) {
        this.lists = lists;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        LikeBean.DataBean.RecordsBean recordsBean = lists.get(position);
        Glide.with(context)
