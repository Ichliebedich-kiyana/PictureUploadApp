...
public class SaveListAdapter extends RecyclerView.Adapter<SaveListAdapter.ViewHolder> {
    ...
    private List<SaveBean.DataBean.RecordsBean> lists;
    ...
    public SaveListAdapter(List<SaveBean.DataBean.RecordsBean> lists) {
        this.lists = lists;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        SaveBean.DataBean.RecordsBean recordsBean = lists.get(position);
        Glide.with(context)
