...
public class CollectListAdapter extends RecyclerView.Adapter<CollectListAdapter.ViewHolder> {
    ...
    private List<CollectBean.DataBean.RecordsBean> lists;
    ...
    public CollectListAdapter(List<CollectBean.DataBean.RecordsBean> lists) {
        this.lists = lists;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        CollectBean.DataBean.RecordsBean recordsBean = lists.get(position);
        Glide.with(context)
